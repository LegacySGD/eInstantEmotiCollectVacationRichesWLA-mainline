...
public class EmotiCollectVacationRichesWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(EmotiCollectVacationRichesWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/EmotiCollectVacationRichesWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/EmotiCollectVacationRichesWLAIW/InitOutcome.xml").getDocumentElement();
